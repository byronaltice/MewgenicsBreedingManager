...
- At the end of a loop (when you reach a stopping point and are about to wait for the user), push your accumulated commits on `main` to `origin/main`. Within a loop, commit and merge locally but do not push intermediate work. Avoid pushing your worktree branch unless for a specific reason.

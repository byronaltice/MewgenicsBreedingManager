...
| `subagents/`                                      | Resources supporting multi-agent workflow: sub-agent briefing documents, shared rules, and example prompts. Indexed in `subagents/AGENTS.md`. Agent definitions live at `.claude/agents/<name>.md`. |